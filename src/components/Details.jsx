function Details () {
  return (
    <div className='details mx-auto mt-5 flex flex-col items-start text-left  md:mt-2 md:items-center md:text-center'>
      <h1 className='text-[1.7rem] text-slate-900 dark:text-gray-200 md:text-4xl'>
        El Chiringuito Deportivo
      </h1>
      <p className='mt-3 mb-5 max-w-3xl px-0 text-sm text-gray-900 dark:text-slate-200 md:mt-4 md:px-4 md:text-base md:leading-7'>
